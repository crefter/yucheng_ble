// Autogenerated from Pigeon (v26.2.1), do not edit directly.
...
private class YuchengBleApiPigeonCodecReader: FlutterStandardReader {
  override func readValue(ofType type: UInt8) -> Any? {
    ...
    case 159:
      return YuchengToken.fromList(self.readValue() as! [Any?])
    default:
...
private class YuchengBleApiPigeonCodecWriter: FlutterStandardWriter {
  override func writeValue(_ value: Any) {
    if let value = value as? YuchengSleepType {
      ...
      super.writeByte(158)
      super.writeValue(value.toList())
    } else if let value = value as? YuchengToken {
      super.writeByte(159)
      super.writeValue(value.toList())
    } else {
...
protocol YuchengHostApi {
  ...
  func turnOnBackgroundService(delayInMinutes: Int64, completion: @escaping (Result<Bool, Error>) -> Void)
...
class YuchengHostApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: YuchengHostApi?, messageChannelSuffix: String = "") {
    ...
    let turnOnBackgroundServiceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.yucheng_ble.YuchengHostApi.turnOnBackgroundService\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      turnOnBackgroundServiceChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let delayInMinutesArg = args[0] as! Int64
        api.turnOnBackgroundService(delayInMinutes: delayInMinutesArg) { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      turnOnBackgroundServiceChannel.setMessageHandler(nil)
    }
    let turnOffBackgroundServiceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.yucheng_ble.YuchengHostApi.turnOffBackgroundService\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      turnOffBackgroundServiceChannel.setMessageHandler { _, reply in
        api.turnOffBackgroundService { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      turnOffBackgroundServiceChannel.setMessageHandler(nil)
    }
    let canLaunchBackgroundServiceChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.yucheng_ble.YuchengHostApi.canLaunchBackgroundService\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      canLaunchBackgroundServiceChannel.setMessageHandler { _, reply in
        api.canLaunchBackgroundService { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      canLaunchBackgroundServiceChannel.setMessageHandler(nil)
    }
    let setFlavorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.yucheng_ble.YuchengHostApi.setFlavor\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setFlavorChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let flavorNameArg = args[0] as! String
        api.setFlavor(flavorName: flavorNameArg) { result in
          switch result {
          case .success:
            reply(wrapResult(nil))
          case .failure(let error):
      ...
      setFlavorChannel.setMessageHandler(nil)
    }
    let setTokenChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.yucheng_ble.YuchengHostApi.setToken\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      ...
      setTokenChannel.setMessageHandler(nil)
    }
    let getTokenChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.yucheng_ble.YuchengHostApi.getToken\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
